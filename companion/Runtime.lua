...
local function Loaded(_,name)
    ...
    SLASH_COMMANDS["/asbuildshare"]=function(text)
        ...
        if command=="on" then
            SetEnabled(true)
            Print("Controlled-test sharing ON. Current group members using compatible sharing can request your equipped items, both skill bars, Champion stars, food, potion and class choices. Protocol IDs are provisional; use only with your test group.")
