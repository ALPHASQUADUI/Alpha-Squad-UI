...
Class Masteries require committed, eligible selections. Front/back equipment activation is evaluated separately. The set headline uses the highest known bar total; unknown requirements never produce a guessed excess warning. A selected potion is preparation evidence, not proof of consumption. Tooltips may use viewer-dependent native stat calculations, which must be identified for shared skills.
